...
export function positionSet(crcl, pos) {
...
export const listenDel = (el, type, listener, capture) =>
...
export function clickForAll(el, selector, handler) {
	el.querySelectorAll(selector).forEach(

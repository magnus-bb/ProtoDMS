...
These values are committed to git - you should use regular environment variables for the secret configs.
...
module.exports = env => ({
  ...
  */
	PUBLIC_URL: env.PUBLIC_URL || '/', // PUBLIC_URL: "http://localhost:8055"
  ...
  */
	...
	KEY: env.KEY || '5c23e3a4-7bda-4b94-8528-ea0c1123fa5a', // this is only used in dev, so don't even bother
	// Secret string for the project
	SECRET: env.SECRET || 'I5Bg-700dp4_KSEpLNVbWHD0crfyOYLw', // this is only used in dev, so don't even bother
